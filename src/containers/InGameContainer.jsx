...
export default function InGameContainer() {
    ...
    const passTurn = async (turnData) => {
        const response = await fetch("http://127.0.0.1:8000/skip_turn", {
            method: "POST",
        ...
        if (result) {
            setMovCards((prevMovCards) => {
                ...
                if (selectedIndex !== null) {
                    ...
                    updatedMovCards[selectedIndex] = [
                        updatedMovCards[selectedIndex][0],
                        "played",
                    ];
                }
    ...
    return (
        <Game
            ...
            onConfirmMovement={ConfirmMovement}
        />
    );
}
